...
const About = () => {
  ...
  const features = [
    {
      ...
      description: "Upload a photo of any item and our AI instantly identifies it, telling you exactly how to recycle or repurpose it creatively.",
      color: "from-emerald-500 to-teal-500"
    },
    {
      icon: MessageCircle,
      title: "EcoFy Chatbot",
      description: "Get personalized eco-tips, DIY upcycling ideas, and sustainability advice through our friendly AI companion.",
      color: "from-green-500 to-emerald-500"
    },
    {
      icon: Recycle,
      title: "Reuse & Recycle Guide",
      description: "Discover creative ways to give new life to everyday items. Turn waste into treasures with step-by-step DIY guides.",
      color: "from-teal-500 to-cyan-500"
    },
    {
      icon: Calculator,
      title: "Carbon Calculator",
      description: "Track your environmental impact and see how your recycling efforts contribute to reducing carbon emissions.",
      color: "from-cyan-500 to-blue-500"
    },
    {
      icon: Users,
      title: "Eco Community",
      description: "Connect with like-minded eco-warriors, share your upcycling projects, and inspire others to live sustainably.",
      color: "from-emerald-500 to-green-500"
    },
    {
      icon: Award,
      title: "Eco Points & Rewards",
      description: "Earn points for every eco-friendly action. Track your progress and unlock achievements as you help save the planet.",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-emerald-50/30 to-white">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 relative">
          <div className="flex items-center justify-between mb-8">
            ...
            >
              <img src="/ecofy-logo.png" alt="EcoFy" className="w-12 h-12" />
              <span className="text-2xl font-bold">EcoFy</span>
            </button>
            <Button
              onClick={() => navigate("/auth")}
              className="bg-primary hover:bg-primary/90 text-white font-semibold px-6 py-2 rounded-xl"
            >
              Get Started
            </Button>
          </div>
          ...
          <div className="text-center max-w-4xl mx-auto mt-12">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium">Empowering Sustainable Living</span>
            </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {impactStats.map((stat, index) => (
            <div 
              key={index}
              className="bg-white rounded-2xl p-6 shadow-lg shadow-primary/5 border border-primary/10 text-center hover:shadow-xl hover:scale-105 transition-all duration-300"
            >
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="group bg-white rounded-2xl p-8 shadow-lg shadow-primary/5 border border-primary/10 hover:shadow-2xl hover:border-primary/30 transition-all duration-300 hover:-translate-y-1"
            >
      ...
      <div className="bg-gradient-to-br from-primary/5 via-emerald-50 to-secondary/5 py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { step: "1", title: "Upload or Describe", desc: "Take a photo of any item or describe it to our AI chatbot" },
              { step: "2", title: "Get Smart Suggestions", desc: "Receive personalized ideas for recycling, reusing, or upcycling" },
              { step: "3", title: "Make an Impact", desc: "Follow the guides, earn eco-points, and track your environmental contribution" }
            ].map((item, index) => (
        ...
        <div className="bg-gradient-to-br from-primary to-secondary rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {["Reduce Waste", "Inspire Action", "Build Community", "Save the Planet"].map((item, i) => (
      ...
      <footer className="bg-gray-50 border-t border-gray-100 py-8">
        <div className="container mx-auto px-4 text-center text-gray-500">
          ...
          <p className="text-sm">© 2024 EcoFy. Making sustainability simple, one item at a time.</p>
        </div>
      </footer>
    </div>
  );
